...
class MainState(GameState):
    ...
    def process_event(self, event: pygame.event.Event) -> None:
        """Process the event from the operating system."""
        self._current_player().process_event(event)

    def update(self) -> GameState:
        """Update this GameState based on the player's move.

        Return the AnimateGameState that should be updated. This can be self.
        """
...
class AnimateMoveState(GameState):
    ...
    def update(self) -> GameState:
        """Update this GameState based on the animation.
...
class GameOverState(GameState):
    ...
    def update(self) -> GameState:
        """Return self as there is nothing to change."""
        # Nothing to change
        return self

    def render(self, renderer: Renderer) -> None:
        """Render the final results on the screen.
        """
        x = 10
        y = 10
